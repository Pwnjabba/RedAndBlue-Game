...
public class PixelPerfect : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (_camera && followTarget)
		{
			...
			_camera.transform.position = new Vector3(nextX / _pixelLockedPPU, nextY / _pixelLockedPPU + cameraYOffset, _camera.transform.position.z);
		}

		if (blue.isActive)
		{
			followTarget = blue.gameObject;
		}
		else if (red.isActive)
		{
			followTarget = red.gameObject;
		}
	}
}